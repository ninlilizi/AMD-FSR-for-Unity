...
namespace NKLI
{
    ...
    public class FSR_Editor : Editor
    {
        ...
        SerializedProperty m_FlipZBuffer;
        ...
        void DrawFSRSettings()
        {
            ...
            EditorGUILayout.PropertyField(m_FlipZBuffer, new GUIContent(" Flip depth buffer on copy"));
        ...
        void OnEnable()
        {
            ...
            m_FlipZBuffer = serializedObject.FindProperty("FlipDepthBuffer");
